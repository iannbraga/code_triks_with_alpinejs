...
- **Funcionalidades** Estilos diferentes e músiscas de fundo
- **Arquivos:**
...
- **Funcionalidades** Salvar senhas no LocalStorage do navegador, validar força da senha
- **Arquivos:**
...
- **Funcionalidades** Variações do cronômetro: Pomodoro, Ciclos, Academia, Poker, Xadrez, Contagem regressiva (temporizador),
- **Arquivos:**
...
- **Funcionalidades** Estilos diferentes.
- **Arquivos:**
...
- **Funcionalidades** Categorias de sorteio: nome, número, usuário (instagram, tiktok), sorteio sinuca, xadrez, poker.
- **Arquivos:**
  1. **index.html** - Entrada de faixa e botão para sortear.
  2. **script.js** - Função para gerar o número aleatório.

### **9. Caixa de Texto com Contador de Caracteres e Palavras**
...
### **10. Quiz Interativo**
- **Descrição:** Um quiz simples com lista de perguntas e respostas.
- **Funcionalidades** Permite cadastrar as perguntas e respostas, e compartilhar o link.
- **Arquivos:**
...
- **Funcionalidades** Alterar texto e velocidade do efeito.
- **Arquivos:**
...
- **Funcionalidades** Uma estrada com um carro que deve percorrer o trajeto nós semáforos corretos.
- **Arquivos:**
...
- **Funcionalidades** Calculadora básica, científica, com fórmulas prontas (Baskhara, etc)
- **Arquivos:**
...
- **Funcionalidades** Compartilhar texto personalizado no whatsapp, telegram, instagram, tiktok, etc.
- **Arquivos:**
...
### **33. Animação de Carregamento (Loader)**
...
### **52. Localizador de Coordenadas Geográficas**
...
### **58. Simulador de Relógio Mundial**
